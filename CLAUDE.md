...
- Current progress → concise `docs/Tracker.md` §10 log (+ task status).
- Metrics/protocols/verdicts → `docs/Evaluation.md`; techniques, literature, hypotheses and negative results → `docs/Research.md`.
